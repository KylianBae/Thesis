...
def cytotype_dynamics(initial_population:list,max_generations:int):
    ...
    while t < max_generations:
        ...
        freq_diploid.append(sum(1 for individual in new_pop if len(individual) == 2))
        freq_triploid.append(sum(1 for individual in new_pop if len(individual) == 3))
        freq_tetraploid.append(sum(1 for individual in new_pop if len(individual) == 4))
        t += 1
...
print(makeplot(cytotype_dynamics(x,1000000)[0:]))
